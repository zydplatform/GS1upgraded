  ...
  //login user to get token
        ...
        if ((usernameError == true && passwordError == true))
        {
          ...
          let password = $('#password').val().trim();   
            ...
            $.ajax({
                url: "localhost:1701/authenticate",
                type: "POST",
    ...
    $("#addbusiness").on('click', function (e) {
            ...
            $.ajax({
                ...
                url: "localhost:1701/businessProfiles",
                type: "POST",
                dataType: "json",
        ...
        $.ajax({
        url: "localhost:1701/businessProfiles/all",
        type: "GET",
        dataType: "json",
        crossDomain: true,
        cache: false,
        ...
        $.ajax({
        url: 'localhost:1701/countries/all',
        type: "GET",
        dataType: "json",
        crossDomain: true,
        cache: false,
      ...
      $("#addbusinessline").on('click', function (e) {
            ...
            $.ajax({
                ...
                url: "localhost:1701/businessLines",
                type: "POST",
                dataType: "json",
                crossDomain: true,
                cache: false,
        ...
        $.ajax({
        url: 'localhost:1701/businessLines/all',
        type: "GET",
        dataType: "json",
        cache: false,
        crossDomain: true,
...
$("#addbusinesstype").on('click', function (e) {
            ...
            $.ajax({
                ...
                url: "localhost:1701/businessTypes",
                type: "POST",
                dataType: "json",
                crossDomain: true,
                cache: false,
        ...
        $.ajax({
        url: 'localhost:1701/businessTypes/all',
        type: "GET",
        dataType: "json",
        crossDomain: true,
        cache: false,
        ...
        $.ajax({
        url: 'localhost:1701/districts/all',
        type: "GET",
        dataType: "json",
        crossDomain: true,
        cache: false,
      ...
      $("#addproduct").on('click', function (e) {
            ...
            $.ajax({
                ...
                url: "localhost:1701/itemCatelogues",
                type: "POST",
                dataType: "json",
                crossDomain: true,
                cache: false,
        ...
        $.ajax({
        url: 'localhost:1701/itemCatelogues/all',
        type: "GET",
        dataType: "json",
        crossDomain: true,
        cache: false,
